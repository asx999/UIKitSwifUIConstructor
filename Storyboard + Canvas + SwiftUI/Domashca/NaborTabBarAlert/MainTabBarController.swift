...
final class MainTabBarController: UITabBarController {
    ...
    private var customLayoutController = CustomLayoutController()
    ...
    private func generateTabBar() {
        viewControllers = [
            createNavController(vc: newViewController, itemName: "NewController", itemImage: "pencil.and.outline"),
            createNavController(vc: customLayoutController, itemName: "CustomLayout", itemImage: "bolt.horizontal.fill"),
